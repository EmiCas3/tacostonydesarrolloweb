...
<body>
    ...
    <div class="main-content-top">
        <div class="formulario-card">
            ...
            ?>
            <div class="total-box">
                <span>Total de <?php echo $meses[$mes_sel]; ?> de <?php echo $anio_sel; ?>: $<?php echo number_format($totalGeneral, 2); ?></span>
    ...
    <script>
        ...
        function descargarPDF() {
            ...
            var opt = {
                margin: 10,
                filename: 'Reporte_Ingreso_<?php echo $meses[$mes_sel] . "_" . $anio_sel; ?>.pdf',
