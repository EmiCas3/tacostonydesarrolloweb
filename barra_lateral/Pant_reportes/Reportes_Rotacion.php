    ...
    <div class="main-content-top">
        <div class="formulario-card">
            ...
            <div class="barra-info-reporte">
                <?php $meses_es = ['','Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']; echo 'Rotación de Productos ' . $meses_es[$mes_sel] . ' ' . $anio_sel; ?>
            </div>
            <div class="total-box">
