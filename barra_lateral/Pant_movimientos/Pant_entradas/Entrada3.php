...
<head>
    ...
    <title>Tacos Tony - Movimientos - Entradas - Confirmar</title>
...
<body>
    ...
    <div class="main-content">
        <div class="formulario-card">
            ...
            <div class="botones-bottom">
                ...
                <a class="btn-accion" onclick="confirmarEntrada()">CONFIRMAR</a>
            </div>
    ...
    <script>
        window.onload = function () {
            ...
            if (!storedData) {
                alert("Error: No se encontraron los datos de la entrada");
